        ...
        <div class="box-body">
            <div class="row" style="margin:5px">
                <div class="col-lg-6 col-xs-6">
                    <a href="{{ asset('/pedido') }}" class="btn btn-primary col-lg-12 col-xs-12" ><i class="fa fa-arrow-circle-left"></i> Regresar</a>
                </div>
                <div class="col-lg-6 col-xs-6">
                    <a href="{{ asset('/pedido/create') }}" class="btn btn-success col-lg-12 col-xs-12" ><i class="fa fa-save"></i> Guardar</a>
                </div>
            </div>
