...
<div class="content">
    ...
    <div class="box box-primary">
        <div class="box-body">
                ...
                <div id="contenedor_pedido" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                </div>
                <div id="contenedor_pedido_pop" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                </div>
        </div>
    </div>
</div>
@endsection
@section('scripts')
    <script src="{{ asset('js/lista_pedidos_mesero.js') }}"></script>
