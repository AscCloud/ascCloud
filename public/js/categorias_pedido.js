                ...
                if(response == "-1"){
                    ...
                    var fillSecondary = function(){
                      ...
                      response.forEach(function(element,index){
                            ...
                            cadena=cadena +'<a href="'+origin+pathName+'/pedido/detalle/add/'+element['id']+'"><div class="form-group col-sm-12 col-xs-12 btn btn-success"><span style="color:white" class="glyphicon glyphicon-plus"</span></div></a>';
                            cadena=cadena +'</div>';
